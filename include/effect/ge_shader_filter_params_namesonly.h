...
constexpr char GE_SHADER_HALO_EFFECT[] = "HaloEffect";
constexpr char GE_SHADER_HALO_EFFECT_MASK[] = "HaloEffect_Mask";
constexpr char GE_SHADER_HALO_EFFECT_MASKCLOCK[] = "HaloEffect_MaskClock";
constexpr char GE_SHADER_HALO_EFFECT_MASKPROGRESS[] = "HaloEffect_MaskProgress";
constexpr char GE_SHADER_HALO_EFFECT_USEEFFECTMASK[] = "HaloEffect_UseEffectMask";
constexpr char GE_SHADER_HALO_EFFECT_TINTCOLOR[] = "HaloEffect_TintColor";
constexpr char GE_SHADER_HALO_EFFECT_RIPPLEPOSITION[] = "HaloEffect_RipplePosition";
constexpr char GE_SHADER_HALO_EFFECT_RIPPLEPROGRESS[] = "HaloEffect_RippleProgress";
constexpr char GE_SHADER_HALO_EFFECT_DISTORTPROGRESS[] = "HaloEffect_DistortProgress";
constexpr char GE_SHADER_HALO_EFFECT_DISTORTFACTOR[] = "HaloEffect_DistortFactor";
constexpr char GE_SHADER_HALO_EFFECT_REFLECTIONFACTOR[] = "HaloEffect_ReflectionFactor";
constexpr char GE_SHADER_HALO_EFFECT_REFRACTIONFACTOR[] = "HaloEffect_RefractionFactor";
constexpr char GE_SHADER_HALO_EFFECT_BLURLEFT[] = "HaloEffect_BlurLeft";
constexpr char GE_SHADER_HALO_EFFECT_BLURTOP[] = "HaloEffect_BlurTop";
constexpr char GE_SHADER_HALO_EFFECT_MATERIALFACTOR[] = "HaloEffect_MaterialFactor";
constexpr char GE_SHADER_HALO_EFFECT_CORNERRADIUS[] = "HaloEffect_CornerRadius";
constexpr char GE_SHADER_HALO_EFFECT_RATE[] = "HaloEffect_Rate";
constexpr char GE_SHADER_HALO_EFFECT_LIGHTUPDEGREE[] = "HaloEffect_LightUpDegree";
constexpr char GE_SHADER_HALO_EFFECT_CUBICCOEFF[] = "HaloEffect_CubicCoeff";
constexpr char GE_SHADER_HALO_EFFECT_QUADCOEFF[] = "HaloEffect_QuadCoeff";
constexpr char GE_SHADER_HALO_EFFECT_SATURATION[] = "HaloEffect_Saturation";
constexpr char GE_SHADER_HALO_EFFECT_POSRGB[] = "HaloEffect_PosRGB";
constexpr char GE_SHADER_HALO_EFFECT_NEGRGB[] = "HaloEffect_NegRGB";
constexpr char GE_SHADER_HALO_EFFECT_FRACTION[] = "HaloEffect_Fraction";
constexpr char GE_SHADER_HALO_EFFECT_TOTALMATRIX[] = "HaloEffect_TotalMatrix";
