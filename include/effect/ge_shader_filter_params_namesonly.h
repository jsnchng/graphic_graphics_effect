...
constexpr char GE_SHADER_CELIA_BALL_EFFECT[] = "CeliaBallEffect";
constexpr char GE_SHADER_CELIA_BALL_EFFECT_MASK[] = "CeliaBallEffect_Mask";
constexpr char GE_SHADER_CELIA_BALL_EFFECT_MASKCLOCK[] = "CeliaBallEffect_MaskClock";
constexpr char GE_SHADER_CELIA_BALL_EFFECT_MASKPROGRESS[] = "CeliaBallEffect_MaskProgress";
constexpr char GE_SHADER_CELIA_BALL_EFFECT_USEEFFECTMASK[] = "CeliaBallEffect_UseEffectMask";
constexpr char GE_SHADER_CELIA_BALL_EFFECT_TINTCOLOR[] = "CeliaBallEffect_TintColor";
constexpr char GE_SHADER_CELIA_BALL_EFFECT_RIPPLEPOSITION[] = "CeliaBallEffect_RipplePosition";
constexpr char GE_SHADER_CELIA_BALL_EFFECT_RIPPLEPROGRESS[] = "CeliaBallEffect_RippleProgress";
constexpr char GE_SHADER_CELIA_BALL_EFFECT_DISTORTPROGRESS[] = "CeliaBallEffect_DistortProgress";
constexpr char GE_SHADER_CELIA_BALL_EFFECT_DISTORTFACTOR[] = "CeliaBallEffect_DistortFactor";
constexpr char GE_SHADER_CELIA_BALL_EFFECT_REFLECTIONFACTOR[] = "CeliaBallEffect_ReflectionFactor";
constexpr char GE_SHADER_CELIA_BALL_EFFECT_REFRACTIONFACTOR[] = "CeliaBallEffect_RefractionFactor";
constexpr char GE_SHADER_CELIA_BALL_EFFECT_BLURLEFT[] = "CeliaBallEffect_BlurLeft";
constexpr char GE_SHADER_CELIA_BALL_EFFECT_BLURTOP[] = "CeliaBallEffect_BlurTop";
constexpr char GE_SHADER_CELIA_BALL_EFFECT_MATERIALFACTOR[] = "CeliaBallEffect_MaterialFactor";
constexpr char GE_SHADER_CELIA_BALL_EFFECT_CORNERRADIUS[] = "CeliaBallEffect_CornerRadius";
constexpr char GE_SHADER_CELIA_BALL_EFFECT_RATE[] = "CeliaBallEffect_Rate";
constexpr char GE_SHADER_CELIA_BALL_EFFECT_LIGHTUPDEGREE[] = "CeliaBallEffect_LightUpDegree";
constexpr char GE_SHADER_CELIA_BALL_EFFECT_CUBICCOEFF[] = "CeliaBallEffect_CubicCoeff";
constexpr char GE_SHADER_CELIA_BALL_EFFECT_QUADCOEFF[] = "CeliaBallEffect_QuadCoeff";
constexpr char GE_SHADER_CELIA_BALL_EFFECT_SATURATION[] = "CeliaBallEffect_Saturation";
constexpr char GE_SHADER_CELIA_BALL_EFFECT_POSRGB[] = "CeliaBallEffect_PosRGB";
constexpr char GE_SHADER_CELIA_BALL_EFFECT_NEGRGB[] = "CeliaBallEffect_NegRGB";
constexpr char GE_SHADER_CELIA_BALL_EFFECT_FRACTION[] = "CeliaBallEffect_Fraction";
constexpr char GE_SHADER_CELIA_BALL_EFFECT_TOTALMATRIX[] = "CeliaBallEffect_TotalMatrix";
