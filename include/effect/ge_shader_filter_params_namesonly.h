...
constexpr char GE_MASK_WARPED_RING_CENTER[] = "WarpedRingMask_Center";
constexpr char GE_MASK_WARPED_RING_RADIUS[] = "WarpedRingMask_Radius";
constexpr char GE_MASK_WARPED_RING_WIDTH[] = "WarpedRingMask_Width";
constexpr char GE_MASK_WARPED_RING_WIDTH_CENTER_OFFSET[] = "WarpedRingMask_Offset";
...
constexpr char GE_FILTER_SPIN_BLUR_COLOR[] = "SpinBlur_Colors";
constexpr char GE_FILTER_SPIN_BLUR_POSITION[] = "SpinBlur_Positions";
constexpr char GE_FILTER_SPIN_BLUR_STRENGTH[] = "SpinBlur_Strengths";
constexpr char GE_FILTER_SPIN_BLUR_MASK[] = "SpinBlur_Mask";
