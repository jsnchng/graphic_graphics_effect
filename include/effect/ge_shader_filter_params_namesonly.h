...
constexpr char GE_SHADER_CELIA_EFFECT[] = "CeliaEffect";
constexpr char GE_SHADER_CELIA_EFFECT_MASK[] = "CeliaEffect_Mask";
constexpr char GE_SHADER_CELIA_EFFECT_MASKCLOCK[] = "CeliaEffect_MaskClock";
constexpr char GE_SHADER_CELIA_EFFECT_MASKPROGRESS[] = "CeliaEffect_MaskProgress";
constexpr char GE_SHADER_CELIA_EFFECT_USEEFFECTMASK[] = "CeliaEffect_UseEffectMask";
constexpr char GE_SHADER_CELIA_EFFECT_TINTCOLOR[] = "CeliaEffect_TintColor";
constexpr char GE_SHADER_CELIA_EFFECT_RIPPLEPOSITION[] = "CeliaEffect_RipplePosition";
constexpr char GE_SHADER_CELIA_EFFECT_RIPPLEPROGRESS[] = "CeliaEffect_RippleProgress";
constexpr char GE_SHADER_CELIA_EFFECT_DISTORTPROGRESS[] = "CeliaEffect_DistortProgress";
constexpr char GE_SHADER_CELIA_EFFECT_DISTORTFACTOR[] = "CeliaEffect_DistortFactor";
constexpr char GE_SHADER_CELIA_EFFECT_REFLECTIONFACTOR[] = "CeliaEffect_ReflectionFactor";
constexpr char GE_SHADER_CELIA_EFFECT_REFRACTIONFACTOR[] = "CeliaEffect_RefractionFactor";
constexpr char GE_SHADER_CELIA_EFFECT_BLURLEFT[] = "CeliaEffect_BlurLeft";
constexpr char GE_SHADER_CELIA_EFFECT_BLURTOP[] = "CeliaEffect_BlurTop";
constexpr char GE_SHADER_CELIA_EFFECT_MATERIALFACTOR[] = "CeliaEffect_MaterialFactor";
constexpr char GE_SHADER_CELIA_EFFECT_CORNERRADIUS[] = "CeliaEffect_CornerRadius";
constexpr char GE_SHADER_CELIA_EFFECT_RATE[] = "CeliaEffect_Rate";
constexpr char GE_SHADER_CELIA_EFFECT_LIGHTUPDEGREE[] = "CeliaEffect_LightUpDegree";
constexpr char GE_SHADER_CELIA_EFFECT_CUBICCOEFF[] = "CeliaEffect_CubicCoeff";
constexpr char GE_SHADER_CELIA_EFFECT_QUADCOEFF[] = "CeliaEffect_QuadCoeff";
constexpr char GE_SHADER_CELIA_EFFECT_SATURATION[] = "CeliaEffect_Saturation";
constexpr char GE_SHADER_CELIA_EFFECT_POSRGB[] = "CeliaEffect_PosRGB";
constexpr char GE_SHADER_CELIA_EFFECT_NEGRGB[] = "CeliaEffect_NegRGB";
constexpr char GE_SHADER_CELIA_EFFECT_FRACTION[] = "CeliaEffect_Fraction";
constexpr char GE_SHADER_CELIA_EFFECT_TOTALMATRIX[] = "CeliaEffect_TotalMatrix";
